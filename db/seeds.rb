...
(1..10).each do |index|
  Product.create([
    { title: "Product #{index}", subtitle: "Subtitle for product #{index}", short_description: "Short description for product #{index}. Lorem ipsum dolor sit amet", content: "Content for product #{index}. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquam libero et purus ornare, interdum volutpat nulla semper. Nullam rhoncus placerat magna nec imperdiet. Suspendisse potenti. Morbi non erat sit amet est fringilla pulvinar a at odio. Aliquam quis volutpat dolor, et convallis neque. Cras orci arcu, pellentesque vel luctus vel, vehicula at mauris. Vestibulum et urna dictum lorem dignissim iaculis eu pellentesque ipsum. Nunc non nisl dignissim, malesuada tortor sed, aliquet justo. Mauris aliquam lacus turpis, vehicula mattis velit.", category: category01 }
  ])
end
