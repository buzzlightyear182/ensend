class Admin::TabsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tab.save
        format.html { redirect_to admin_tabs_path, notice: 'Tab was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tab.update(tab_params)
        format.html { redirect_to admin_tabs_path, notice: 'Tab was successfully updated.' }
  ...
  def destroy
    @tab.destroy
    respond_to do |format|
      format.html { redirect_to admin_tabs_path, notice: 'Tab was successfully destroyed.' }
