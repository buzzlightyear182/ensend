class Admin::CommissionTypesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_commission_types_path, notice: 'Commission type was successfully destroyed.' }
  ...
  private
    ...
    def commission_type_params
      params.require(:commission_type).permit(:name, :label, :icon)
    end
end
